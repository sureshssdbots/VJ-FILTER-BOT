...
BOT_TOKEN = environ.get('BOT_TOKEN', "8004078816:AAHZVjLEsFjmvXqAPYit53M8IkHWMN9xIyY")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6529821294 6151975257').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002250698221').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sureshsiyagssb:<Dilipbhaai77>@bot.p4fho.mongodb.net/?retryWrites=true&w=majority&appName=Bot")   # IF Multiple Database Is False Then Fill Only This Database Url.
